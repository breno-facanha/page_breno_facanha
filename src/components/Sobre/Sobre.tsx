...
export default function Sobre() {
    return (
        <div className="w-full h-auto bg-gray-50 flex flex-col items-center pt-25 text-center px-2 sm:pt-40">
            ...
            <p className="text-gray-600 text-xl font-medium p-0 m-0 pt-5"> Especializado em criar experiências digitais e modernas e funcionais</p>
            <p className="text-gray-600 text-xl font-medium p-0 m-0">Transformo ideias em código limpo e soluções eficientes</p>
            ...
            <div className="animate-bounce flex h-auto justify-end items-center mt-10">
                <MoveDown color="gray"/>
            </div>
        </div>
    );
